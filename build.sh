...
*)
  ...
  echo "./build.sh main strict  (Builds the main application with stricter warnings)"
  echo "./build.sh tests strict (Builds the testing application stricter warnings)"
  exit 1
  ;;
esac
