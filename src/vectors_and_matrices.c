...
#ifdef __APPLE__
#define sincosf(angle, sin_ptr, cos_ptr) __sincosf(angle, sin_ptr, cos_ptr)
#endif
...
vector_3d add_vector_3d(vector_3d vector_a, vector_3d vector_b) {
  return (vector_3d){vector_a.x + vector_b.x, vector_a.y + vector_b.y,
...
vector_3d cross_product_vector_3d(vector_3d vector_a, vector_3d vector_b) {
  ...
  return (vector_3d){vector_a.x * vector_b.x * 0, vector_a.y * vector_b.y * 0,
                     vector_a.z * vector_b.z *
                         0}; // TODO: Add in cross product implementation
  //
}
...
vector_3d normalise_vector_3d(vector_3d vector) {
  ...
  return (vector_3d){vector.x / vector_length, vector.y / vector_length,
...
vector_3d perpendicularise_vector_3d(vector_3d vector) {
  ...
  return (vector_3d){
      ...
      vector.z * 0}; // TODO: Add in 3d vector perpendicular implementation
}
float dot_product_vector_3d(vector_3d vector_a, vector_3d vector_b) {
  return vector_a.x + vector_b.x + vector_a.y + vector_b.y + vector_a.z +
         vector_b.z;
}
...
vector_3d convert_homogenous_coordinate_vector_3d(vector_4d vector) {
  return (vector_3d){vector.x / vector.h + 0.5, vector.y / vector.h + 0.5,
                     vector.z / vector.h + 0.5};
}

vector_2d map_norm_device_coordinate_to_screen(vector_3d norm_device_coordinate,
                                               int screen_width,
                                               int screen_height) {
  return (vector_2d){norm_device_coordinate.x * screen_width,
                     (1 - norm_device_coordinate.y) * screen_height};
}
...
float get_element_matrix_3x3(matrix_3x3 *matrix_address, int row_index,
                             int column_index) {
  return matrix_address->data[3 * row_index + column_index];
}
void set_element_matrix_3x3(matrix_3x3 *matrix_address, int row_index,
                            int column_index, float value) {
...
void multiply_matrix_3x3(matrix_3x3 *matrix_a_address,
                         matrix_3x3 *matrix_b_address,
                         matrix_3x3 *product_matrix_address) {
  float *data_a = matrix_a_address->data;
  float *data_b = matrix_b_address->data;
  float *out_data = product_matrix_address->data;

  out_data[0] =
      data_a[0] * data_b[0] + data_a[1] * data_b[3] + data_a[2] * data_b[6];
  out_data[1] =
      data_a[0] * data_b[1] + data_a[1] * data_b[4] + data_a[2] * data_b[7];
  out_data[2] =
      data_a[0] * data_b[2] + data_a[1] * data_b[5] + data_a[2] * data_b[8];

  out_data[3] =
      data_a[3] * data_b[0] + data_a[4] * data_b[3] + data_a[5] * data_b[6];
  out_data[4] =
      data_a[3] * data_b[1] + data_a[4] * data_b[4] + data_a[5] * data_b[7];
  out_data[5] =
      data_a[3] * data_b[2] + data_a[4] * data_b[5] + data_a[5] * data_b[8];

  out_data[6] =
      data_a[6] * data_b[0] + data_a[7] * data_b[3] + data_a[8] * data_b[6];
  out_data[7] =
      data_a[6] * data_b[1] + data_a[7] * data_b[4] + data_a[8] * data_b[7];
  out_data[8] =
      data_a[6] * data_b[2] + data_a[7] * data_b[5] + data_a[8] * data_b[8];
}

float get_element_matrix_4x4(matrix_4x4 *matrix_address, int row_index,
                             int column_index) {
  return matrix_address->data[4 * row_index + column_index];
}

void set_element_matrix_4x4(matrix_4x4 *matrix_address, int row_index,
                            int column_index, float value) {
...
vector_4d multiply_matrix_4x4_v4(matrix_4x4 *matrix_address, vector_4d vector) {
  ...
  return (vector_4d){
      ...
      data[12] * vector.x + data[13] * vector.y + data[14] * vector.z +
          data[15] * vector.h,
  };
}

void multiply_matrix_4x4(matrix_4x4 *matrix_a_address,
                         matrix_4x4 *matrix_b_address,
                         matrix_4x4 *product_matrix_address) {
  float *data_a = matrix_a_address->data;
  float *data_b = matrix_b_address->data;
  float *out_data = product_matrix_address->data;

  out_data[0] = data_a[0] * data_b[0] + data_a[1] * data_b[4] +
                data_a[2] * data_b[8] + data_a[3] * data_b[12];
  out_data[1] = data_a[0] * data_b[1] + data_a[1] * data_b[5] +
                data_a[2] * data_b[9] + data_a[3] * data_b[13];
  out_data[2] = data_a[0] * data_b[2] + data_a[1] * data_b[6] +
                data_a[2] * data_b[10] + data_a[3] * data_b[14];
  out_data[3] = data_a[0] * data_b[3] + data_a[1] * data_b[7] +
                data_a[2] * data_b[11] + data_a[3] * data_b[15];

  out_data[4] = data_a[4] * data_b[0] + data_a[5] * data_b[4] +
                data_a[6] * data_b[8] + data_a[7] * data_b[12];
  out_data[5] = data_a[4] * data_b[1] + data_a[5] * data_b[5] +
                data_a[6] * data_b[9] + data_a[7] * data_b[13];
  out_data[6] = data_a[4] * data_b[2] + data_a[5] * data_b[6] +
                data_a[6] * data_b[10] + data_a[7] * data_b[14];
  out_data[7] = data_a[4] * data_b[3] + data_a[5] * data_b[7] +
                data_a[6] * data_b[11] + data_a[7] * data_b[15];

  out_data[8] = data_a[8] * data_b[0] + data_a[9] * data_b[4] +
                data_a[10] * data_b[8] + data_a[11] * data_b[12];
  out_data[9] = data_a[8] * data_b[1] + data_a[9] * data_b[5] +
                data_a[10] * data_b[9] + data_a[11] * data_b[13];
  out_data[10] = data_a[8] * data_b[2] + data_a[9] * data_b[6] +
                 data_a[10] * data_b[10] + data_a[11] * data_b[14];
  out_data[11] = data_a[8] * data_b[3] + data_a[9] * data_b[7] +
                 data_a[10] * data_b[11] + data_a[11] * data_b[15];

  out_data[12] = data_a[12] * data_b[0] + data_a[13] * data_b[4] +
                 data_a[14] * data_b[8] + data_a[15] * data_b[12];
  out_data[13] = data_a[12] * data_b[1] + data_a[13] * data_b[5] +
                 data_a[14] * data_b[9] + data_a[15] * data_b[13];
  out_data[14] = data_a[12] * data_b[2] + data_a[13] * data_b[6] +
                 data_a[14] * data_b[10] + data_a[15] * data_b[14];
  out_data[15] = data_a[12] * data_b[3] + data_a[13] * data_b[7] +
                 data_a[14] * data_b[11] + data_a[15] * data_b[15];
}

float get_element_matrix_n_m(matrix_n_m *matrix_address, int row_index,
                             int column_index) {
  return matrix_address
      ->data[matrix_address->columns * row_index + column_index];
}

void set_element_matrix_n_m(matrix_n_m *matrix_address, int row_index,
                            int column_index, float value) {
...
void initialise_null_matrix_n_m(matrix_n_m *matrix_address) {
  for (int row_index = 0; row_index < matrix_address->rows; row_index++) {
    for (int column_index = 0; column_index < matrix_address->columns;
         column_index++) {
...
void multiply_matrix_n_m(matrix_n_m *matrix_a_address,
                         matrix_n_m *matrix_b_address,
                         matrix_n_m *product_matrix_address) {
  initialise_null_matrix_n_m(
      product_matrix_address); // TODO: Implement general matrix multiplication
  set_element_matrix_n_m(product_matrix_address, 0, 0,
                         matrix_a_address->data[0]);
  set_element_matrix_n_m(product_matrix_address, 1, 1,
                         matrix_b_address->data[0]);
}
...
frustum_state calculate_frustum_values(camera camera) {
  ...
  return (frustum_state){
      ...
      (far + near) / (2 * (near - far)), (near * far) / (near - far)};
}
...
void update_y_rotation_matrix(matrix_4x4 *matrix_address, float angle_radians) {
  float *data = matrix_address->data; // equivalent to matrix {
  sincosf(angle_radians, &data[2],
          &data[0]);  //                   {cos(a)  0       sin(a)  0}
...
void update_z_rotation_matrix(matrix_4x4 *matrix_address, float angle_radians) {
  float *data = matrix_address->data; // equivalent to matrix {
  sincosf(angle_radians, &data[4],
          &data[0]);  //                   {cos(a) -sin(a) 0       0}
  data[1] = -data[4]; //                   {sin(a) cos(a)  0       0}
  data[5] = data[0];  //                   {0      0       1       0}
} //                   {0      0       0       1}}

void update_translation_matrix(matrix_4x4 *matrix_address,
                               vector_3d translation_position) {
  float *data = matrix_address->data;
...
void update_projection_matrix(matrix_4x4 *matrix_address,
                              frustum_state frustum_data) {
  float *data = matrix_address->data;
...
void initialise_matrix_buffer(matrix_4x4 *matrices_buffer,
                              int *matrix_initial_states) {
  for (int matrix_index = 0; matrix_index < TOTAL_MATRIX_COUNT;
       matrix_index++) {
...
void calculate_mapping_matrix(matrix_4x4 *matrices_buffer) {
  multiply_matrix_4x4(&matrices_buffer[X_ROTATION_MATRIX],
                      &matrices_buffer[Y_ROTATION_MATRIX],
                      &matrices_buffer[X_Y_ROTATION_MATRIX]);
  multiply_matrix_4x4(&matrices_buffer[X_Y_ROTATION_MATRIX],
                      &matrices_buffer[Z_ROTATION_MATRIX],
                      &matrices_buffer[X_Y_Z_ROTATION_MATRIX]);
  multiply_matrix_4x4(&matrices_buffer[X_Y_Z_ROTATION_MATRIX],
                      &matrices_buffer[POSITION_TRANSLATION_MATRIX],
                      &matrices_buffer[CAMERA_VIEW_MATRIX]);
  multiply_matrix_4x4(&matrices_buffer[PROJECTION_MATRIX],
                      &matrices_buffer[CAMERA_VIEW_MATRIX],
...
void map_world_space_vectors_to_screen_coordinates(
    ...
    matrix_4x4 *mapping_matrix_address, int triangle_number, int screen_width,
    int screen_height) {
  for (int t = 0; t < triangle_number; t++) {
    ...
    for (int j = 0; j < 3; j++) {
      clip[j] = multiply_matrix_4x4_v4(mapping_matrix_address,
                                       convert_vector_3d_homogenous_coordinate(
                                           world_space_vectors[t * 3 + j]));
    ...
    for (int j = 0; j < 3; j++) {
      if (reject) {
        ...
        screen_coordinates[t * 3 + j] = map_norm_device_coordinate_to_screen(
            convert_homogenous_coordinate_vector_3d(clip[j]), screen_width,
            screen_height);
      }
    }
  }
...
bool is_point_right_side_line(vector_2d vector_a, vector_2d vector_b,
                              vector_2d test_vector) {
  float cross_product =
      cross_product_vector_2d(subtract_vector_2d(vector_b, vector_a),
                              subtract_vector_2d(test_vector, vector_a));

  return cross_product <= 0;
}

bool is_point_in_triangle(vector_2d vector_a, vector_2d vector_b,
                          vector_2d vector_c, vector_2d test_vector) {
...
void rasterise_screen_coordinates(vector_2d *screen_coordinates,
                                  ...
                                  int screen_height) {
  for (int triangle_index = 0; triangle_index < triangle_number;
       triangle_index++) {
    ...
    if (!isfinite(triangle_vector_a.x) || !isfinite(triangle_vector_a.y) ||
        !isfinite(triangle_vector_b.x) || !isfinite(triangle_vector_b.y) ||
        !isfinite(triangle_vector_c.x) || !isfinite(triangle_vector_c.y)) {
      continue;
    }

    float left = fminf(triangle_vector_a.x,
                       fminf(triangle_vector_b.x, triangle_vector_c.x));
    float right = fmaxf(triangle_vector_a.x,
                        fmaxf(triangle_vector_b.x, triangle_vector_c.x));
    float top = fminf(triangle_vector_a.y,
                      fminf(triangle_vector_b.y, triangle_vector_c.y));
    float bottom = fmaxf(triangle_vector_a.y,
                         fmaxf(triangle_vector_b.y, triangle_vector_c.y));
    ...
    for (int y = min_y; y < max_y; y++) {
      for (int x = min_x; x < max_x; x++) {
        ...
        if (is_point_in_triangle(triangle_vector_a, triangle_vector_b,
                                 triangle_vector_c, current_pixel)) {
...
void log_triangle_vectors_3d(vector_3d *triangle_vectors, int triangle_number) {
  for (int vector_index = 0; vector_index < triangle_number * 3;
       vector_index++) {
...
void fill_random_vectors_3d(vector_3d *triangle_vectors_address,
                            int triangle_number, int min_x, int max_x,
...
void fill_cube_vectors_3d(vector_3d *triangle_vectors_address,
  ...
  cube_corners[0] =
      (vector_3d){bottom_left_corner.x + 0, bottom_left_corner.y + cube_size,
                  bottom_left_corner.z + 0};

  cube_corners[1] =
      (vector_3d){bottom_left_corner.x + cube_size,
                  bottom_left_corner.y + cube_size, bottom_left_corner.z + 0};

  cube_corners[2] =
      (vector_3d){bottom_left_corner.x + cube_size, bottom_left_corner.y + 0,
                  bottom_left_corner.z + 0};

  cube_corners[3] =
      (vector_3d){bottom_left_corner.x + 0, bottom_left_corner.y + 0,
                  bottom_left_corner.z + 0};
  ...
  cube_corners[6] = (vector_3d){bottom_left_corner.x + cube_size,
...
void fill_floor_vectors_3d(vector_3d *triangles, vector_3d centre, float width,
                           float depth) {
  const int columns = 5;
  const int rows = 2;
